...
if 'fda_df' in st.session_state and 'tw_df' in st.session_state:
    if st.button("開始比對"):
        with st.spinner("比對中..."):
            ...
            result_df = format_date(result_df, date_col="date")   # ✅ 格式化日期
            special_df = format_date(special_df, date_col="date") # ✅ 格式化日期
